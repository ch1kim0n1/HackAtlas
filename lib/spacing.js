...
function generateBorderRadius(theme, random) {
  ...
  if (theme.archetype && theme.archetype.borderRadius !== undefined) {
    return {
      'none': '0',
      'sm': theme.archetype.borderRadius,
      'base': theme.archetype.borderRadius,
      'md': theme.archetype.borderRadius,
      'lg': theme.archetype.borderRadius,
      'xl': theme.archetype.borderRadius,
      '2xl': theme.archetype.borderRadius,
      '3xl': theme.archetype.borderRadius,
      'full': '9999px',
    };
  }
...
function generateShadows(theme, random) {
  const isHard = theme.archetype && theme.archetype.shadowType === 'hard';
  ...
  if (isHard) {
    return {
      ...
      'xl': '16px 16px 0px 0px rgba(0, 0, 0, 1)',
      '2xl': '24px 24px 0px 0px rgba(0, 0, 0, 1)',
