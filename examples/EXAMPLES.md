...
Generate a design system with the cyberpunk theme:

```bash
atlas generate --theme cyberpunk --seed my-hackathon-2024
```

This creates a `design-system` folder with all your design tokens.

## Example 2: Using in HTML/CSS
